        ...
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <div className="px-2 py-6 sm:px-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {/* Viva Mode Card */}
              <div className="bg-white overflow-hidden shadow sm:rounded-lg hover:shadow-lg transition-shadow focus-within:ring-2 focus-within:ring-indigo-500" tabIndex={0} aria-label="Viva Mode">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Viva Mode</h3>
                  <p className="mt-1 max-w-2xl text-sm text-gray-700">Practice coding interviews in a video call format with AI feedback.</p>
                  <div className="mt-5">
                    <Link href="/viva" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-label="Start Viva">Start Viva</Link>
                  </div>
                </div>
              </div>
              {/* MCQs Mode Card */}
